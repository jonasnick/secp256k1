...
/** Opaque data structure that holds a secret and public key.
 *
 *  The exact representation of data inside is implementation defined and not
 *  guaranteed to be portable between different platforms or versions. It is
 ...
 *               be NULL).
 *  In: input32: pointer to a serialized xonly public key (cannot be NULL)
 */
 ...
 *
 *  The output_pubkey is represented by the pk_parity, which is obtained by
 *  converting the output_pubkey to a secp256k1_xonly_pubkey, and the 32 byte
 *  byte serialization of the secp256k1_xonly_pubkey.
 *
...
/** Get the xonly public key from a keypair.
 *
